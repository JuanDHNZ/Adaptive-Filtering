...
plt.scatter(QKLMS['CB_size']/n_train, QKLMS['testing_mse'], marker='*')
plt.scatter(QKLMS_AKB['CB_size']/n_train, QKLMS_AKB['testing_mse'], marker='X')
plt.scatter(QKLMS_AMK['CB_size']/n_train, QKLMS_AMK['testing_mse'], marker='>')
plt.yscale("log")
plt.xscale("log")
plt.xlabel('Codebook')
